...
parser.add_argument('--width', type=int, default=1, help="width of the roads in the ground truth mask")
...
for image_file in image_files:
	...
	# Write the mask file
	cv2.imwrite(os.path.join(args.ground_directory, "ground_truth_{}.tif".format(image_file[15:-4])), mask)
